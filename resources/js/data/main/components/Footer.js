...
import SocialBar from './plugins/SocialBar'
const Footer = () => {
    return (
        <Div>
            <div className="footer">
                <div className="footer_agile_inner_info_w3l row">
                    <div className="col-md-3 footer-left">
                        <h2><a href="/"><span>C</span>razyDeals </a></h2>
                    ...
                    <p className="copy-right">&copy 2020 Crazy Deals. All rights reserved | Design by <a
                        href="aslamwebz.github.com">EM Aslam @ Webzon</a></p>
                </div>
            </div>
        </Div>
    )
